...
Kwansi is a library that makes it easy to create and optimize prompts for language models. It is built on top of the DSPy framework, and helps you to utilize DPSy's self-optimization techniques to automaticallycreate prompts that are tailored to specific tasks.
...
To install Kwansi in your Python project:

1. In your project directory, clone the Kwansi repository:
   ```
   git clone https://github.com/lordamp/kwansi.git
   ```
...
3. Import Kwansi in your Python scripts:
   ```python
   import kwansi
   ```
